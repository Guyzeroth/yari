...
export interface redirectOptions {
  permanent: boolean;
  colonToSlash?: boolean | undefined;
}
...
type templateArgs = ((arg0: any) => any) | string;

const PrependLocale = false;
const DoNotPrependLocale = false;
...
function externalRedirect(pattern: RegExp, template: ((any) => any) | string) {
  return localeRedirect(pattern, template, DoNotPrependLocale, {
    permanent: true,
  });
}
...
const SCL3_REDIRECT_PATTERNS = [
  ...
  // [R=301,L]
  localeRedirect(/^mobile\/?$/i, "/docs/Mozilla/Mobile", PrependLocale, {
    permanent: true,
  }),
  // RewriteRule ^(\w{2,3}(?:-\w{2})?/)?addons/?$ /$1Add-ons [R=301,L]
  localeRedirect(/^addons\/?$/i, "/Add-ons", PrependLocale, {
    permanent: true,
  }),
  // RewriteRule ^(\w{2,3}(?:-\w{2})?/)?mozilla/?$ /$1docs/Mozilla [R=301,L]
  localeRedirect(/^mozilla\/?$/i, "/docs/Mozilla", PrependLocale, {
    permanent: true,
  }),
  // RewriteRule ^(\w{2,3}(?:-\w{2})?/)?web/?$ /$1docs/Web [R=301,L]
  localeRedirect(/^web\/?$/i, "/docs/Web", PrependLocale, { permanent: true }),
  ...
  localeRedirect(/^HTML5$/i, "/docs/HTML/HTML5", PrependLocale, {
    permanent: true,
  }),
  ...
  localeRedirect(/^docs\/?$/i, "/docs/Web", PrependLocale, { permanent: true }),
  // DevNews
  ...
  localeRedirect(/^learn\/html/i, "/docs/Learn/HTML", PrependLocale, {
    permanent: true,
  }),
  // RewriteRule ^(\w{2,3}(?:-\w{2})?/)?learn/css /$1Learn/CSS [R=301,L]
  localeRedirect(/^learn\/css/i, "/docs/Learn/CSS", PrependLocale, {
    permanent: true,
  }),
  ...
  localeRedirect(/^learn/i, "/docs/Learn", PrependLocale, { permanent: true }),
...
[
  ...
  FIREFOX_SOURCE_DOCS_REDIRECT_PATTERNS.push(
    externalRedirect(pattern as RegExp, FIREFOX_SOURCE_DOCS_ROOT_URL + path)
  )
);
...
const MISC_REDIRECT_PATTERNS = [
  ...
  localeRedirect(/^account\/?$/i, "/settings", PrependLocale, {
    permanent: false,
  }),
  localeRedirect(/^profile(?:|\/edit)\/?$/i, "/settings", PrependLocale, {
    permanent: false,
  }),
  localeRedirect(
